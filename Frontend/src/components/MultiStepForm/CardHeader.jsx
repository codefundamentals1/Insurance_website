...
function CardHeader(props) {
    return (
        <div className="min-h-full">
            ...
            <div className="h-full w-48 flex flex-col gap-4 p-4 bg-gray-200">
                <div className="flex w-full gap-2 items-center">
                    <div className="h-8 w-8 bg-gray-300 flex items-center justify-center rounded-full">1</div>
                    <div className="font-bold">Your Info</div>
                </div>
                <div className="flex w-full gap-2 items-center">
                    <div className="h-8 w-8 bg-gray-300 flex items-center justify-center rounded-full">1</div>
                    <div className="font-bold">Your Info</div>
